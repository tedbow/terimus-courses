...
class TerminusBase extends Command{
  /**
  ...
  protected function getEnvNames($envs) {
    return array_map(function($e) {
      return $e->Name;
    }, $envs);
  }
  protected function delEnvs($envs) {
    $dialog = $this->getHelper('dialog');
    $confirm =  $dialog->askConfirmation(
      $this->output,
  ...
  protected function createEnvs($env, $count) {
    for ($c = 0; $c < $count; $c++) {
  ...
  protected function validateEnvName($env_name) {
